...
import id.indrasudirman.belajarbahasainggris.adapter.PastPerfectAdapter;
...
public class PastPerfectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager2.setAdapter(new PastPerfectAdapter(this));
...
//        tabLayout.clearOnTabSelectedListeners();
    ...
    private void checkAnswerTest1() {
        ...
        if (numberOfQuestionCorrect == 2) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PastPerfectActivity.this);
            alertDialogBuilder
                    .setTitle("Selamat!")
    ...
    private boolean checkQuestionTestOne1() {
        ...
        String key = "daed5a4e3a8701d85a84c3ea2f2f834d";
    ...
    private boolean checkQuestionTestOne2() {
        ...
        String key = "867d235e8fb9963889864dd634ddd8a8";
    ...
    private boolean checkQuestionTestTwo1() {
        ...
        String key = "98cb43a595ac0036833efc507248d6d9";
    ...
    private boolean checkQuestionTestTwo2() {
        ...
        String key = "11dfd868d93bc2b0e4ce0bee5756f8b1"; //sini
    ...
    private boolean checkQuestionTestTwo3() {
        ...
        String key = "12de3a4dab98ef8a7d67aace8150b540";
    ...
    private boolean checkQuestionTestTwo7() {
        ...
        String key = "e9393bc3b718a2f7cd9b418ae948351c";
    ...
    private boolean checkQuestionTestTwo9() {
        ...
        String key = "ecae13117d6f0584c25a9da6c8f8415e";
    ...
    private void finishOnTheLastPage() {
        ...
        alertDialogBuilder
                .setTitle("Selamat!")
                .setMessage("Pembelajaran Past Perfect Tense sudah selesai. Anda dapat melanjutkan ke pelajaran berikutnya Present Perfect Tense.")
                .setCancelable(false)
                .setPositiveButton("Present Perfect Tense",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                //Set Score user to 5
                                ...
                                sqLiteHelper.updateUserScore(userEmail, "9");
                                startActivity(new Intent(getApplicationContext()
                                        ,MainMenu.class));
                                overridePendingTransition(0, 0);
                            }
