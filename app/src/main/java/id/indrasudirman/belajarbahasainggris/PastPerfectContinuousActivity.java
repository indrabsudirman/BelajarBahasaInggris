...
import id.indrasudirman.belajarbahasainggris.adapter.PastPerfectContinuousAdapter;
...
public class PastPerfectContinuousActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager2.setAdapter(new PastPerfectContinuousAdapter(this));
...
//        tabLayout.clearOnTabSelectedListeners();
    ...
    private void checkAnswerTest1() {
        ...
        if (numberOfQuestionCorrect == 2) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PastPerfectContinuousActivity.this);
            alertDialogBuilder
                    .setTitle("Selamat!")
    ...
    private boolean checkQuestionTestOne1() {
        ...
        String key = "6069bc86aac17842c1ec129c47254e98";
    ...
    private boolean checkQuestionTestOne2() {
        ...
        String key = "52fb03876f421911cb5231096eefabb2";
    ...
    private boolean checkQuestionTestTwo2() {
        ...
        String key = "a56999c4920482ae454bc8c44937cce1";
    ...
    private boolean checkQuestionTestTwo3() {
        ...
        String key = "1abdf26375f03af4bab6c4f4da6d99fd";
    ...
    private boolean checkQuestionTestTwo5() {
        ...
        String key = "a1e6cd7f9480f01643245e0b648d9fbe";
    ...
    private boolean checkQuestionTestTwo7() {
        ...
        String key = "fe7ffef4a3a7ccf6717c0685ee02cc5b";
    ...
    private boolean checkQuestionTestTwo10() {
        ...
        String key = "4623a63aa0029c7813af7c61f819cb52";
    ...
    private void finishOnTheLastPage() {
        ...
        alertDialogBuilder
                .setTitle("Selamat!")
                .setMessage("Pembelajaran Past Perfect Continuous Tense sudah selesai. Anda dapat melanjutkan ke pelajaran berikutnya Present Perfect Continuous Tense.")
                .setCancelable(false)
                .setPositiveButton("Present Perfect Continuous Tense",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                //Set Score user to 5
                                ...
                                sqLiteHelper.updateUserScore(userEmail, "13");
                                startActivity(new Intent(getApplicationContext()
                                        ,MainMenu.class));
                                overridePendingTransition(0, 0);
                            }
