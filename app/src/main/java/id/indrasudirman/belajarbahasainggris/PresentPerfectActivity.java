...
public class PresentPerfectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager2.setAdapter(new PresentPerfectAdapter(this));
...
//        tabLayout.clearOnTabSelectedListeners();
    ...
    private boolean checkQuestionTestOne1() {
        ...
        String key = "1eb11fa40ad86dc718f22de970e27b99";
    ...
    private boolean checkQuestionTestOne2() {
        ...
        String key = "e2d4e0dcd3ab4c25d4c73bf7b6e5166d";
    ...
    private boolean checkQuestionTestTwo1() {
        ...
        String key = "3309a7a7941818e131b4dfb9a6349914";
    ...
    private boolean checkQuestionTestTwo4() {
        ...
        String key = "c54b3f9fd17931f9e9c7095bbbc7a5d5";
    ...
    private boolean checkQuestionTestTwo6() {
        ...
        String key = "a4700e713f1af77bf91ee2f9242cbb0b";
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Future Perfect Tense",
                        (dialogInterface, i) -> {
                            ...
                            sqLiteHelper.updateUserScore(userEmail, "10");
                            startActivity(new Intent(getApplicationContext()
                                    ,MainMenu.class));
                            overridePendingTransition(0, 0);
                        });
