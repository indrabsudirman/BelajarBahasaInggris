...
public class FutureContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {

    private View view;
    private TextInputEditText dropFutureContinuousOne;
    private TextInputEditText dropFutureContinuousTwo;
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "will staying";
    private static final String TEXT_VIEW_OPTION_TWO = "will be staying";
    private static final String TEXT_VIEW_OPTION_THREE = "will sleeping";
    private static final String TEXT_VIEW_OPTION_FOUR = "will be sleeping";
    ...
    private MyScrollView scrollViewFutureContinuous2;



    public FutureContinuousFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_future_continuous2, container, false);

        findView();
        implementEventTooltips();
        implementEvent();
        //SCROLLVIEW
        scrollViewFutureContinuous2.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewFutureContinuous2.getScrollY();
            }
        });
    ...
    private void findView() {
        ...
        dropFutureContinuousTwo = view.findViewById(R.id.dropFutureContinuousTwo);
        disableEditText(dropFutureContinuousTwo);
        ...
        scrollViewFutureContinuous2 = view.findViewById(R.id.scrollViewFutureContinuous2);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.tooltipsDropFutureContinuousTwo) {
                ViewTarget target = new ViewTarget(R.id.dropFutureContinuousTwo, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
    ...
    private void implementEvent() {
        ...
        dropFutureContinuousTwo.setOnDragListener(this);
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewFutureContinuous2.smoothScrollBy(0, -5);
                }
