...
public class FuturePerfectFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_SIX = "married";
    private static final String TEXT_VIEW_OPTION_SEVEN = "will";
    private static final String TEXT_VIEW_OPTION_EIGHT = "have received";
    private static final String TEXT_VIEW_OPTION_NINE = "have repaired";
    private static final String TEXT_VIEW_OPTION_TEN = "will";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_future_perfect4, container, false);
