...
public class FuturePerfectContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "will has been running";
    private static final String TEXT_VIEW_OPTION_TWO = "will have been running";
    private static final String TEXT_VIEW_OPTION_THREE = "will have been living";
    private static final String TEXT_VIEW_OPTION_FOUR = "will have been lived";
    ...
    public FuturePerfectContinuousFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_future_perfect_continuous2, container, false);
