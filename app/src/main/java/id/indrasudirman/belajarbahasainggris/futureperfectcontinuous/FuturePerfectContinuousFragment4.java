...
public class FuturePerfectContinuousFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "have";
    private static final String TEXT_VIEW_OPTION_TWO = "being";
    private static final String TEXT_VIEW_OPTION_THREE = "will not";
    private static final String TEXT_VIEW_OPTION_FOUR = "been going";
    private static final String TEXT_VIEW_OPTION_FIVE = "will have";
    private static final String TEXT_VIEW_OPTION_SIX = "been teaching";
    private static final String TEXT_VIEW_OPTION_SEVEN = "been studying";
    private static final String TEXT_VIEW_OPTION_EIGHT = "will";
    private static final String TEXT_VIEW_OPTION_NINE = "working";
    private static final String TEXT_VIEW_OPTION_TEN = "have";
    ...
    public FuturePerfectContinuousFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_future_perfect_continuous4, container, false);
