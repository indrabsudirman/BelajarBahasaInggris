...
public class PastContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {

    private View view;
    private TextInputEditText dropPastContinuousOne;
    private TextInputEditText dropPastContinuousTwo;
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "is typing";
    private static final String TEXT_VIEW_OPTION_TWO = "is playing";
    private static final String TEXT_VIEW_OPTION_THREE = "was playing";
    private static final String TEXT_VIEW_OPTION_FOUR = "was typing";
    ...
    private MyScrollView scrollViewPastContinuous2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollViewPastContinuous2.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewPastContinuous2.getScrollY();
            }
        });
    ...
    private void findView() {
        ...
        dropPastContinuousTwo = view.findViewById(R.id.dropPastContinuousTwo);
        disableEditText(dropPastContinuousTwo);
        ...
        scrollViewPastContinuous2 = view.findViewById(R.id.scrollViewPastContinuous2);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.tooltipsDropPastContinuousTwo) {
                ViewTarget target = new ViewTarget(R.id.dropPastContinuousTwo, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
    ...
    private void implementEvent() {
        ...
        dropPastContinuousTwo.setOnDragListener(this);
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewPastContinuous2.smoothScrollBy(0, -5);
                }
