...
public class PastFutureContinuousFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    private View view;
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "should be eating";
    private static final String TEXT_VIEW_OPTION_TWO = "last";
    private static final String TEXT_VIEW_OPTION_THREE = "be camping";
    private static final String TEXT_VIEW_OPTION_FOUR = "should";
    private static final String TEXT_VIEW_OPTION_FIVE = "be a student";
    private static final String TEXT_VIEW_OPTION_SIX = "would";
    private static final String TEXT_VIEW_OPTION_SEVEN = "be playing";
    private static final String TEXT_VIEW_OPTION_EIGHT = "would";
    private static final String TEXT_VIEW_OPTION_NINE = "be learning";
    private static final String TEXT_VIEW_OPTION_TEN = "would";
    ...
    public PastFutureContinuousFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_past_future_continuous4, container, false);
        findView();
        implementEvent();
