...
public class PastFuturePerfectFragment3 extends Fragment {
    ...
    private void mSpannableString() {
        SpannableString[] spannableString = new SpannableString[]{
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_verbal_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_verbal_positive_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_verbal_negative_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_verbal_question_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_nominal_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_nominal_positive_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_nominal_negative_past_future_perfect))),
                new SpannableString((getActivity().getResources().getString(R.string.bentuk_kalimat_nominal_question_past_future_perfect)))};
        ...
        // verbalPositive
        spannableString[1].setSpan(clickableSpanVerbalPositive,87,106,0);
        // make text bold
        spannableString[1].setSpan(new StyleSpan(Typeface.BOLD), 87,106, 0);
