...
public class PastFuturePerfectFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "have arrived";
    private static final String TEXT_VIEW_OPTION_TWO = "would";
    private static final String TEXT_VIEW_OPTION_THREE = "should";
    private static final String TEXT_VIEW_OPTION_FOUR = "started";
    private static final String TEXT_VIEW_OPTION_FIVE = "not";
    private static final String TEXT_VIEW_OPTION_SIX = "came";
    private static final String TEXT_VIEW_OPTION_SEVEN = "would";
    private static final String TEXT_VIEW_OPTION_EIGHT = "have been";
    private static final String TEXT_VIEW_OPTION_NINE = "would";
    private static final String TEXT_VIEW_OPTION_TEN = "done";
    ...
    public PastFuturePerfectFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_past_future_perfect4, container, false);
