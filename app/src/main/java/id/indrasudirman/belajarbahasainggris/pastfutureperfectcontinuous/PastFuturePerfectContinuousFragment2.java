...
public class PastFuturePerfectContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {

    private View view;
    private TextInputEditText dropAnswerOne;
    private TextInputEditText dropAnswerTwo;
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "would have been studying";
    private static final String TEXT_VIEW_OPTION_TWO = "should have be waiting";
    private static final String TEXT_VIEW_OPTION_THREE = "should have been waiting";
    private static final String TEXT_VIEW_OPTION_FOUR = "would have be studying";
    ...
    private MyScrollView scrollViewTest1;


    public PastFuturePerfectContinuousFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_past_future_perfect_continuous2, container, false);
        ...
        implementEvent();
        //SCROLLVIEW
        scrollViewTest1.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewTest1.getScrollY();
            }
        });
    ...
    private void findView() {
        dropAnswerOne = view.findViewById(R.id.dropAnswerOne);
        disableEditText(dropAnswerOne);
        dropAnswerTwo = view.findViewById(R.id.dropAnswerTwo);
        disableEditText(dropAnswerTwo);
        ...
        scrollViewTest1 = view.findViewById(R.id.scrollViewTest1);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.tooltipsDropOne) {
                ViewTarget target = new ViewTarget(R.id.dropAnswerOne, getActivity());
            ...
            if (view.getId() == R.id.tooltipsDropTwo) {
                ViewTarget target = new ViewTarget(R.id.dropAnswerTwo, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
    ...
    private void implementEvent() {
        ...
        dropAnswerOne.setOnDragListener(this);
        dropAnswerTwo.setOnDragListener(this);
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewTest1.smoothScrollBy(0, -5);
                }
