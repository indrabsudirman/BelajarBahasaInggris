...
public class PastFuturePerfectContinuousFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "have been finishing";
    private static final String TEXT_VIEW_OPTION_TWO = "would";
    private static final String TEXT_VIEW_OPTION_THREE = "been standing";
    private static final String TEXT_VIEW_OPTION_FOUR = "would not";
    private static final String TEXT_VIEW_OPTION_FIVE = "been living";
    private static final String TEXT_VIEW_OPTION_SIX = "would have";
    private static final String TEXT_VIEW_OPTION_SEVEN = "making";
    private static final String TEXT_VIEW_OPTION_EIGHT = "would have";
    private static final String TEXT_VIEW_OPTION_NINE = "collecting";
    private static final String TEXT_VIEW_OPTION_TEN = "should have";
    ...
    public PastFuturePerfectContinuousFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_past_future_perfect_continuous4, container, false);
