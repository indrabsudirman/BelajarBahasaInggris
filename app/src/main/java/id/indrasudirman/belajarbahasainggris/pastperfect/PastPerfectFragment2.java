...
public class PastPerfectFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "had finished";
    private static final String TEXT_VIEW_OPTION_TWO = "had finish";
    private static final String TEXT_VIEW_OPTION_THREE = "had ate";
    private static final String TEXT_VIEW_OPTION_FOUR = "had eaten";
