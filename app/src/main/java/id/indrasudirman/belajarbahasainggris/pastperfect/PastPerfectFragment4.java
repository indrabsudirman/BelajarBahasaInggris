...
public class PastPerfectFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_EIGHT = "came";
    private static final String TEXT_VIEW_OPTION_NINE = "studied";
    private static final String TEXT_VIEW_OPTION_TEN = "moved";
