...
public class PastPerfectContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "have been worked";
    private static final String TEXT_VIEW_OPTION_TWO = "had been working";
    private static final String TEXT_VIEW_OPTION_THREE = "had been walking";
    private static final String TEXT_VIEW_OPTION_FOUR = "have been walked";
    ...
    public PastPerfectContinuousFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_past_perfect_continuous2, container, false);
