...
public class PresentContinuousFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_TWO = "is a famous";
    private static final String TEXT_VIEW_OPTION_THREE = "are";
    private static final String TEXT_VIEW_OPTION_FOUR = "is";
    private static final String TEXT_VIEW_OPTION_FIVE = "are eating";
    private static final String TEXT_VIEW_OPTION_SIX = "drinking";
    private static final String TEXT_VIEW_OPTION_SEVEN = "is reading";
    private static final String TEXT_VIEW_OPTION_EIGHT = "are a familiar";
    private static final String TEXT_VIEW_OPTION_NINE = "is eating";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //SCROLLVIEW
        scrollViewPresentContinuous4.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewPresentContinuous4.getScrollY();
            }
        });
    ...
    private void findView() {
        ...
        dropPresentContinuousTwoOne = view.findViewById(R.id.dropPresentContinuousTwoOne);
        disableEditText(dropPresentContinuousTwoOne);
        dropPresentContinuousThree = view.findViewById(R.id.dropPresentContinuousThree);
        disableEditText(dropPresentContinuousThree);
        ...
        dropPresentContinuousFourTwo = view.findViewById(R.id.dropPresentContinuousFourTwo);
        disableEditText(dropPresentContinuousFourTwo);
        dropPresentContinuousFive = view.findViewById(R.id.dropPresentContinuousFive);
        disableEditText(dropPresentContinuousFive);
        ...
        scrollViewPresentContinuous4 = view.findViewById(R.id.scrollViewPresentContinuous4);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.tooltipsDropPresentContinuousTwo) {
                ViewTarget target = new ViewTarget(R.id.dropPresentContinuousTwoOne, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
            ...
            if (view.getId() == R.id.tooltipsDropPresentContinuousThree) {
                ViewTarget target = new ViewTarget(R.id.dropPresentContinuousThree, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
            ...
            if (view.getId() == R.id.tooltipsDropPresentContinuousFive) {
                ViewTarget target = new ViewTarget(R.id.dropPresentContinuousFive, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
    ...
    private void implementEvent() {
        ...
        dropPresentContinuousTwoOne.setOnDragListener(this);
        dropPresentContinuousThree.setOnDragListener(this);
        dropPresentContinuousFourOne.setOnDragListener(this);
        dropPresentContinuousFourTwo.setOnDragListener(this);
        dropPresentContinuousFive.setOnDragListener(this);
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewPresentContinuous4.smoothScrollBy(0, -5);
                }
