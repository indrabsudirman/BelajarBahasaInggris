...
public class PresentPerfectFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "has worked";
    private static final String TEXT_VIEW_OPTION_TWO = "had worked";
    private static final String TEXT_VIEW_OPTION_THREE = "have lived";
    private static final String TEXT_VIEW_OPTION_FOUR = "had lived";
