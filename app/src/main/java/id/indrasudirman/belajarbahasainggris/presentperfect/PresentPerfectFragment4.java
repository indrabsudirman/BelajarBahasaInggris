...
public class PresentPerfectFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_TWO = "have";
    private static final String TEXT_VIEW_OPTION_THREE = "has";
    private static final String TEXT_VIEW_OPTION_FOUR = "been";
    private static final String TEXT_VIEW_OPTION_FIVE = "have";
    private static final String TEXT_VIEW_OPTION_SIX = "cleaned";
    private static final String TEXT_VIEW_OPTION_SEVEN = "have";
    private static final String TEXT_VIEW_OPTION_EIGHT = "washed";
    private static final String TEXT_VIEW_OPTION_NINE = "has";
    private static final String TEXT_VIEW_OPTION_TEN = "studied";
    ...
    public PresentPerfectFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_present_perfect4, container, false);
