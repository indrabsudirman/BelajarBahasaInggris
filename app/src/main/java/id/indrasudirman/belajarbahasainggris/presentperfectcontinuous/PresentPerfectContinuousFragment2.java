...
public class PresentPerfectContinuousFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "have been reading";
    private static final String TEXT_VIEW_OPTION_TWO = "has been practicing";
    private static final String TEXT_VIEW_OPTION_THREE = "has been reading";
    private static final String TEXT_VIEW_OPTION_FOUR = "have been practicing";
    ...
    public PresentPerfectContinuousFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_present_perfect_continuous2, container, false);
