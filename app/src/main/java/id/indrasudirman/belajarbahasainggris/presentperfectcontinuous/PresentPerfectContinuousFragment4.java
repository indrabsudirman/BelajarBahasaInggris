...
public class PresentPerfectContinuousFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "been";
    private static final String TEXT_VIEW_OPTION_TWO = "being";
    private static final String TEXT_VIEW_OPTION_THREE = "have been";
    private static final String TEXT_VIEW_OPTION_FOUR = "doing";
    private static final String TEXT_VIEW_OPTION_FIVE = "have";
    private static final String TEXT_VIEW_OPTION_SIX = "been travelling";
    private static final String TEXT_VIEW_OPTION_SEVEN = "have not";
    private static final String TEXT_VIEW_OPTION_EIGHT = "learning";
    private static final String TEXT_VIEW_OPTION_NINE = "have not";
    private static final String TEXT_VIEW_OPTION_TEN = "feeling";
    ...
    public PresentPerfectContinuousFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_present_perfect_continuous4, container, false);
