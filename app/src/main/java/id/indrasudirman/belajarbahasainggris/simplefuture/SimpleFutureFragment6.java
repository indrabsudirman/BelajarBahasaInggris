...
public class SimpleFutureFragment6 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollViewSimpleFuture6.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewSimpleFuture6.getScrollY();
            }
        });
    ...
    private void implementEvent() {
        ...
        dropSimpleFutureOneTwo.setOnDragListener(this);
        ...
        dropSimpleFutureThreeTwo.setOnDragListener(this);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.tooltipsDropSimpleFutureTwo) {
                ViewTarget target = new ViewTarget(R.id.dropSimpleFutureTwo, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
            ...
            if (view.getId() == R.id.tooltipsDropSimpleFutureFour) {
                ViewTarget target = new ViewTarget(R.id.dropSimpleFutureFour, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewSimpleFuture6.smoothScrollBy(0, -5);
                }
