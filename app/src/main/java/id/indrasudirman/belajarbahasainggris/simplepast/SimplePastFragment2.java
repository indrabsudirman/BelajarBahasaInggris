...
public class SimplePastFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    private View view;
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "Visited";
    private static final String TEXT_VIEW_OPTION_TWO = "Lived";
    private static final String TEXT_VIEW_OPTION_THREE = "Ate";
