...
public class SimplePastFutureFragment2 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "know I would";
    private static final String TEXT_VIEW_OPTION_TWO = "knew I would";
    private static final String TEXT_VIEW_OPTION_THREE = "menyatakan prediksi";
    private static final String TEXT_VIEW_OPTION_FOUR = "told me you would";
    private static final String TEXT_VIEW_OPTION_FIVE = "kejadian yang akan dilakukan di masa depan, tapi sudah berlalu";
    private static final String TEXT_VIEW_OPTION_SIX = "tell me you would";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollViewSimplePastFuture2.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewSimplePastFuture2.getScrollY();
            }
        });
    ...
    private void findView() {
        ...
        dropSimplePastFutureTwo = view.findViewById(R.id.dropSimplePastFutureTwo);
        disableEditText(dropSimplePastFutureTwo);
        dropSimplePastFutureThree = view.findViewById(R.id.dropSimplePastFutureThree);
        disableEditText(dropSimplePastFutureThree);
        dropSimplePastFutureFour = view.findViewById(R.id.dropSimplePastFutureFour);
        disableEditText(dropSimplePastFutureFour);
        ...
        scrollViewSimplePastFuture2 = view.findViewById(R.id.scrollViewSimplePastFuture2);
    ...
    private void implementEvent() {
        ...
        dropSimplePastFutureTwo.setOnDragListener(this);
        dropSimplePastFutureThree.setOnDragListener(this);
        dropSimplePastFutureFour.setOnDragListener(this);
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewSimplePastFuture2.smoothScrollBy(0, -5);
                }
