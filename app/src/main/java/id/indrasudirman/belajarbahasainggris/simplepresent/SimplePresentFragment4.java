...
public class SimplePresentFragment4 extends Fragment implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String TEXT_VIEW_OPTION_ONE = "does not";
    private static final String TEXT_VIEW_OPTION_THREE = "are";
    private static final String TEXT_VIEW_OPTION_FOUR = "does";
    private static final String TEXT_VIEW_OPTION_FIVE = "always play";
    private static final String TEXT_VIEW_OPTION_SIX = "always plays";
    ...
    private MyScrollView scrollViewSimplePresent4;


    public SimplePresentFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_simple_present4, container, false);
        ...
        //SCROLLVIEW
        scrollViewSimplePresent4.setOnScrollViewListener(new MyScrollView.OnScrollViewListener() {
            @Override
            public void onScrollChanged1(MyScrollView.OnScrollViewListener listener) {
                mScrollDistance = scrollViewSimplePresent4.getScrollY();
            }
        });
    ...
    private void findView() {
        ...
        scrollViewSimplePresent4 = view.findViewById(R.id.scrollViewSimplePresent4);
    ...
    private final View.OnClickListener clickListenerToolTips = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.tooltipsDropSimplePresentTwo) {
                ViewTarget target = new ViewTarget(R.id.dropSimplePresentTwo, getActivity());
                showcaseView = new ShowcaseView.Builder(getActivity())
                        .setTarget(target)
                        .setContentTitle("Tips")
                        .setContentText("Drop jawabanmu di sini")
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                if (translatedY < 200) {
                    ...
                    scrollViewSimplePresent4.smoothScrollBy(0, -5);
                }
